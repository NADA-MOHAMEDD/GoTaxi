...
const ProfileAmountSelector = ({ onClose, client }) => {
    ...
    return (
        <>
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                <div className="w-[400px] bg-white shadow-lg rounded-3xl p-6 text-center relative">
                    ...
                    />
                    {/* اسم المستخدم */}
                    <h2 className="text-xl font-bold mt-4">Transfer Amount for {client.user}</h2>
                    {/* الموقع */}
                    <div className="flex justify-center items-center text-red-500 mt-1">
                        <FaMapMarkerAlt className="mr-1" />
                        <p className="text-sm">Current Location: {client.startLocation}</p>
                    </div>
                    {/* الحقل */}
                    <div className="mt-6">
                        <input
                    ...
                    <div className="flex justify-between mt-6">
                        <button onClick={onClose} className="px-11 py-2 border border-red-500 text-red-500 rounded-full hover:bg-red-50 focus:outline-none">
                            close
                        </button>
                        <button onClick={() => {
                            // قم بإضافة منطق التحويل هنا
...
export default ProfileAmountSelector;
